...
namespace ReleaseGuard.Editor.Tests
{
    public sealed class ReleaseGuardLoggerTests
    {
        ...
        {
            var report = new ReleaseGuardPreBuildReport(new[]
            {
                new ReleaseIssue("component", ReleaseIssueSeverity.Warning, "Warning message"),
                new ReleaseIssue("component", ReleaseIssueSeverity.Error, "Error message"),
            });
