...
namespace ReleaseGuard.Editor.Builtins.PreBuild
{
    ...
    /// </summary>
    public sealed class ManagedStrippingCheck : ReleaseGuardComponent<ManagedStrippingCheck.Config>
    {
        ...
        {
            var required = Settings.minLevel;
            if (required == ManagedStrippingLevel.Disabled)
                return;
