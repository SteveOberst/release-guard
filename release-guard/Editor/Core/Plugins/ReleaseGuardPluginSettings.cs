...
namespace ReleaseGuard.Editor.Core.Plugins
{
    ...
    /// pages. Override <see cref="ConfigureReader"/> to register additional
    /// <see cref="IComponentReader"/> implementations on the reader for this page, or to
    /// define <c>[NonSerialized] InlineComponent</c> fields for custom-drawn sections.</para>
    ///
    ...
    /// PropertyField.</para>
    ///
    /// <para><b>Section headings:</b> use <c>[SettingsHeader("Heading")]</c> on fields to add
    ...
    {
        /// <summary>
        /// Override to register additional <see cref="IComponentReader"/> implementations on
        /// <paramref name="reader"/> for this plugin's settings page. Called once per settings
        /// page session before the component tree is built.
        /// </summary>
        public virtual void ConfigureReader(SettingsComponentReader reader)
        {
        }
    }
}